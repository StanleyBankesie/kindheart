      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm mt-1">
            Upcoming and overdue receivables by due date
          </p>
        </div>
      </div>
            ...
            <div className="md:col-span-2 flex items-end gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  a.href = url;
                  a.download = "outstanding-receivable.csv";
                  a.click();
              ...
              <button
                ...
                onClick={() => {
                  ...
                  XLSX.utils.book_append_sheet(wb, ws, "OutstandingReceivable");
                  XLSX.writeFile(wb, "outstanding-receivable.xlsx");
                }}
                disabled={!items.length}
              >
                Export Excel
              ...
              <button
                ...
                onClick={() => {
                  ...
                  let y = 15;
                  doc.setFontSize(14);
                  doc.text("Outstanding Receivable Report", 10, y);
                  y += 8;
                  doc.setFontSize(10);
                  ...
                  doc.save("outstanding-receivable.pdf");
                }}
                disabled={!items.length}
              >
                Export PDF
