/**
 * @fileoverview SalesTrackingReportPage component.
 * Provides functionality for SalesTrackingReportPage.
 */
            ...
            <table className="table w-full table-fixed">
              <thead>
                <tr>
                  ...
                  <SortableHeader label="Value" sortKey="value" currentKey={sortKey} direction={sortDir} onToggle={toggle} className="text-right" />
                </tr>
              </thead>
              <tbody>
