/**
 * @fileoverview SystemLogBookPage component.
 * Provides functionality for SystemLogBookPage.
 */
...
export default function SystemLogBookPage() {
  ...
  }, [from, to, userId, selectedModule, quickFilter, pollingCounter]);
  useEffect(() => {
    let cancelled = false;
    let t = null;
